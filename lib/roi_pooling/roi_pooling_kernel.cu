...
int ROIPoolForwardLaucher(const float* bottom_data,
                          const float spatial_scale,
                          const int num_rois,
                          const int height,
                          const int width,
                          ...
                          int* argmax_data)
{
  ...
  ROIPoolForward <<< blocks, kThreadsPerBlock>>> (output_size,
                                                  bottom_data,
                                                  spatial_scale,
                                                  height,
                                                  width,
...
__global__ void ROIPoolBackward(const int nthreads,
...
int ROIPoolBackwardLaucher(const float* top_diff,
                           const float spatial_scale,
                           ...
                           const int* argmax_data)
{
  ...
  int blocks = (output_size + kThreadsPerBlock - 1) / kThreadsPerBlock;
  ROIPoolBackward <<< blocks, kThreadsPerBlock>>> (output_size,
                                                   top_diff,
                                                   argmax_data,
                                                   num_rois,
                                                   spatial_scale,
