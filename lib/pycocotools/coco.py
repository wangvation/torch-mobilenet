...
#  COCO       - COCO api class that loads COCO
#               annotation file and prepare data structures.
...
class COCO:
  def __init__(self, annotation_file=None):
    ...
    Constructor of Microsoft COCO helper class
     for reading and visualizing annotations.
  ...
  def loadNumpyAnnotations(self, data):
    """
    Convert result data from a numpy array [Nx7] where
    each row contains {imageID,x1,y1,w,h,score,class}
